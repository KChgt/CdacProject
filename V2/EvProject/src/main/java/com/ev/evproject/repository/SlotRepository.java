...
public interface SlotRepository extends JpaRepository<ChargingSlot,Long> {
    ...
    ChargingStation findByPortAndVehicleAndChargingStationChargingStationId(Port port, Vehicle vehicle, Long stationId);
    List<ChargingSlot> findByVehicleAndPortAndChargingStation_ChargingStationId(Vehicle vehicle, Port port, Long stationId);
