...
public class SlotServiceImpl implements SlotService{
    ...
    public ChargingSlot checkAvailableSlot(Long stationId, Vehicle vehicle, Port port, LocalDate date, String time) {
        List<ChargingSlot> slotList = new ArrayList<>();
        ...
        for(ChargingSlot slot: chargingSlotList){
            SlotSchedule slotSchedule = scheduleRepository.findByDateAndSlotBooking_SlotBookingId(date, slot.getChargingSlotId());
            switch (time){
                case "zero"->{
