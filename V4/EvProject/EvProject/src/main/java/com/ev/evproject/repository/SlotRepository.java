...
public interface SlotRepository extends JpaRepository<ChargingSlot,Long> {
    ...
    List<ChargingSlot> findByPortAndVehicalAndChargingStationChargingStationId(Port port, Vehicle vehicle, Long stationId);
    ...
    ChargingSlot findByChargingSlotIdAndPortAndVehical(Long id,Port port, Vehicle vehicle);
